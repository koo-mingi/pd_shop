...
public class MediationVO extends DefaultVO {
	...
	private BigDecimal mediationChg;
	...
	public BigDecimal getMediationChg() {
		return mediationChg;
	}

	public void setMediationChg(BigDecimal mediationChg) {
