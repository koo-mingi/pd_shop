...
public class OutFixinfoLawWebVO {

	private String lawsuitAdmNo;	        //소송관리번호
	private String instAdmCode;             //심급     
	private String lawsuitCaseTyCode;	    //사건유형     
	private String lawsuitCpPladefSepcode;  //당사원피고구분   
	private String pladefName;	            //피고           
	private String instAdmCaseNo;           //사건번호     
	private String instAdmPrgrCode;	        //진행상태      
	private String instAdmClamVop;          //청구소가   
	private String instAdmCortCode;         //수행법원   
