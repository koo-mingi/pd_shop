package nexacro.sample.service.impl.rais;
...
import nexacro.sample.service.dao.ibatis.rais.RaisDAO;
...
@Service("raisservice")
public class RaisServiceImpl implements RaisService{
	...
	// 소제기 현황(다시 한  부분)
	@Override
	public List<RaisVO> getRaisList(Map<String, Object> raisMap) {
		return raisDAO.getRaisList(raisMap);			
	}
	...
	public List<RaisreqVO> getRaisreqDetailList(Map<String, Object> param) {
		return raisDAO.getRaisreqDetailList(param);
	}
	...
	public List<RaisDefVO> getRaisreqDefList1(Map<String, String> raisMap) {
		return raisDAO.getRaisreqDefList1(raisMap);
	...
	public String insertRaisreq(Map<String, Object> selectMap) {
		String lawRaisreqNo = "";
		lawRaisreqNo = raisDAO.insertRaisreq(selectMap);
		return lawRaisreqNo;
	}
	...
	public String insertRaisReq(Map<String, Object> raisMap) {
		String lawRaisreqNo = "";
		lawRaisreqNo = raisDAO.insertRaisreq(raisMap); // 저장후 lawRaisreqNo를 받아옴
		return lawRaisreqNo;
	}
