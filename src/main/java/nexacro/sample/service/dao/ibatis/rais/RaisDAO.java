package nexacro.sample.service.dao.ibatis.rais;
...
public class RaisDAO extends NexacroIbatisAbstractDAO {
	...
	public List getRaisList(Map<String, Object> raisMap) {
		return list("rais.raisDAO.getRaisList", raisMap);
	}
	...
	// 피고조회
	@SuppressWarnings("rawtypes")
	public List getRaisreqDefList1(Map<String, String> raisMap) {
		return list("rais.raisDAO.getRaisreqDefList1", raisMap);
	}
	...
	/* raisreq_list.xfdl*/
		...
		public List<RaisreqVO> getRaisreqDetailList(Map<String, Object> param) {
			return (List<RaisreqVO>) list("rais.raisDAO.getRaisreqDetailList", param);
		}
	...
	/* Raisreq_reg.xdfl */
		//소제기 등록
		public String insertRaisreq(Map<String, Object> paramMap) {
			System.out.println("소제기 등록");
			insert("rais.raisDAO.insertRaisreq", paramMap);
			String lawRaisreqNo = (String) paramMap.get("lawRaisreqNo");
			return lawRaisreqNo;
		}
		//소제기 수정
