package nexacro.sample.web.rais;
...
import nexacro.sample.service.rais.RaisService;
import nexacro.sample.vo.out.Law_fix_InfoVO;
import nexacro.sample.vo.rais.RaisDefVO;
import nexacro.sample.vo.rais.RaisSearchVO;
...
//		@ParamVariable(name = "pageNo") String pageNo,
//		@ParamVariable(name = "amount") String amount) {
		System.out.println("ㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇ"+lawRaisreqNo);
...
//		selectMap.put("amount", amount);
	...
	// 소제기검색 (추가한 부분)
	@RequestMapping(value = "/rais/getRaisList.do")
	public NexacroResult getRaisreqList(
		@ParamDataSet(name="ds_input", required=false)RaisSearchVO searchVo
		) {
		System.out.println("ㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇ"+searchVo.getLawRaisreqNo());
		Map<String, Object> selectMap = new HashMap<String, Object>();
		
		selectMap.put("lawRaisreqNo", searchVo.getLawRaisreqNo());    
		selectMap.put("lawRaisreqReqId", searchVo.getLawRaisreqReqId());           
		selectMap.put("lawRaisreqClasCode", searchVo.getLawRaisreqClasCode());
		selectMap.put("lawRaisreqReqDate1", searchVo.getLawRaisreqReqDate1());
		selectMap.put("lawRaisreqReqDate2", searchVo.getLawRaisreqReqDate2());
		selectMap.put("lawRaisreqRepWtr", searchVo.getLawRaisreqRepWtr());
		
		List<RaisVO> raisList = raisservice.getRaisList(selectMap);
	...
	public NexacroResult getRaisreqDetailList(
			@ParamVariable(name = "combo_Clas_Code") String combo_Clas_Code,
			@ParamVariable(name = "edt_No") String edt_No,
			@ParamVariable(name = "radio_Wtr") String radio_Wtr,
			@ParamVariable(name = "cal_Req_Date1") String cal_Req_Date1,
			@ParamVariable(name = "cal_Req_Date2") String cal_Req_Date2){
		Map<String, Object> param  = new HashMap<String, Object>();
		param.put("combo_Clas_Code", combo_Clas_Code);
		param.put("edt_No", edt_No);
		param.put("radio_Wtr", radio_Wtr);
		param.put("cal_Req_Date1", cal_Req_Date1);
		param.put("cal_Req_Date2", cal_Req_Date2);
		System.out.println("conn : "+combo_Clas_Code+" "+edt_No+" "+radio_Wtr+" "+cal_Req_Date1+" "+cal_Req_Date2);
		List<RaisreqVO> raisreqList = raisservice.getRaisreqDetailList(param);

		NexacroResult result = new NexacroResult();
		result.addDataSet("ds_output", raisreqList);
		System.out.println();
		return result;
	}	
	...
	//소제기 관리 창에서의 피고조회 (raisreq_reg.xdfl)
		@RequestMapping(value = "/rais/getRaisreqDefList1.do")
		public NexacroResult getRaisreqDefList1(
			@ParamVariable(name = "raisreqNo") String raisreqNo ) {
			
			Map<String, String> selectMap = new HashMap<String, String>();
			
			selectMap.put("raisreqNo", raisreqNo);            

			List<RaisDefVO> defList = raisservice.getRaisreqDefList1(selectMap);
		...
		public NexacroResult controlRaisDef(
			...
			switch(status){
				case "insert": case "INSERT":
					//소제기 추가 -> 피고(외래키) 추가 
					lawRaisreqNo = raisservice.insertRaisReq(raisMap); // 소제기 추가
			...
			result.addDataSet("ds_output", raisMap);
			return result;
