(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"txt\" type=\"STRING\" size=\"230\"/><Column id=\"lev\" type=\"STRING\" size=\"230\"/></ColumnInfo><Rows><Row><Col id=\"txt\">Recent Menu01</Col><Col id=\"lev\"/></Row><Row><Col id=\"txt\">Recent Menu02</Col><Col id=\"lev\"/></Row><Row><Col id=\"txt\">Recent Menu03</Col><Col id=\"lev\"/></Row><Row><Col id=\"txt\">Recent Menu04</Col><Col id=\"lev\"/></Row><Row><Col id=\"txt\">Recent Menu05</Col><Col id=\"lev\"/></Row><Row><Col id=\"txt\">Recent Menu06</Col><Col id=\"lev\"/></Row><Row><Col id=\"txt\">Recent Menu07</Col><Col id=\"lev\"/></Row><Row><Col id=\"txt\">Recent Menu08</Col><Col id=\"lev\"/></Row><Row><Col id=\"txt\">Recent Menu09</Col><Col id=\"lev\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            this.addChild(obj.name, obj);
            obj = new Grid("grd_tree", "absolute", "0", "248", "228", null, null, "0", this.div_left);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"230\"/></Columns><Rows><Row size=\"37\"/></Rows><Band id=\"body\"><Cell displaytype=\"tree\" edittype=\"tree\" style=\"font: ;\" text=\"bind:MENU_NAME\" editclipmode=\"includespace\" expandshow=\"hide\" expandsize=\"16\" treestartlevel=\"1\" treelevel=\"bind:MENU_LEVEL\"/></Band></Format></Formats>");
        ...
        // User Script
        this.addIncludeScript("LeftFrame.xfdl", "Lib::common.xjs");
        ...
        ***********************************************************************************/
        ...
        this.fnMenuFilterByAuth = function(menuAuth)
        {	
        	if(this.gfn_IsNull(menuAuth))	menuAuth = application.gds_User.getColumn(0,'menuAuth');
            trace("menuAuth is "+menuAuth);
            
            if(menuAuth == 'Y')
            {
        		this.ds_menu.filter('MENU_AUTH=="ADMIN" || MENU_AUTH=="NORMAL" || MENU_AUTH=="OUTLAW"');
        		trace("admin has logined....");
        	}
        	else if(menuAuth == 'O')
        	{
        		this.ds_menu.filter('MENU_AUTH=="OUTLAW"');
        		trace("out lawyer has logined....");
        	}
        	else
        	{
        		this.ds_menu.filter('MENU_AUTH=="NORMAL"');
        		trace("normal user has logined....");
        	}
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_left.Button01.addEventHandler("onclick", this.div_left_Button01_onclick, this);
            this.div_left.Edit00.addEventHandler("oneditclick", this.div_left_Edit00_oneditclick, this);
